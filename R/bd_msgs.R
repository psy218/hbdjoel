...
data = tibble::tribble(
  ...
  "sue",  "Joel, a SSHRC Scholar, a (soon-to-be) father of Bon Bon, a connoisseur of Whiskey Sour, a solar-powered human emitting positive energy and so fucking much life, and the best labmate and friend anyone can ask for. I am grateful I have you in my life, and thank you for existing. Happy birthday \U1F496",
  ...
  "maria", "Happy Birthday, Joel! I hope that you have a FANTASTIC year that matches just how FANTASTIC you are! I hope that this year brings you love, fun, happiness, adventure, success, and health! You deserve to HAVE IT ALL! Hope you have a BLAST celebrating your special day! Cheers to you! Maria \U1F603",
