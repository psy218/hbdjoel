...
data = tibble::tribble(
  ...
  "louisa",  "HAPPY BIRTHDAY JOEL!! celebration May your day of birth be full of dessert and happiness and hopefully we can all celebrate in person together soon! Congratulations on another trip around the sun!!!",
  ...
  "maria", "Happy Birthday, Joel! I hope that you have a FANTASTIC year that matches just how FANTASTIC you are! I hope that this year brings you love, fun, happiness, adventure, success, and health! You deserve to HAVE IT ALL! Hope you have a BLAST celebrating your special day! Cheers to you! Maria smile",
  ...
  "jackie", "heart celebration heart HAPPY BIRTHDAY, JOEL! heart celebration heart  Gone are the days when you were not born! In this SPRQLing era of Joel, we rejoice!! But actually, because YOU are the absolute BEST! I’m so thankful, and joyful, and full of pride to have you as a labmate, collaborator, and friend. I wish you joy, flow, peace, and walks by the water for this year. wave wave wave"
)
